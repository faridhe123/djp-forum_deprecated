<?php
    ...
    class qa_html_theme extends qa_html_theme_base
    {
        ...
        private function donut_site_stats_bottom()
        {
            ...
            $this->output( '<div class="donut-site-stats-bottom" style="background:#FCEC27">
                        <div class="container text-center">
                            <div class="row">
                                <span style="font-size:30px"><strong>Pajak Kita, Untuk Kita</strong></span>
                            </div>
                        </div>
                    </div>' );
        }
        ...
        private function donut_attribution()
        {
            ...
            $this->output(
                    '<div class="qa-attribution">',
                    'Forum Diskusi Direktorat Jendeal Pajak',
                    '</div>'
            );
